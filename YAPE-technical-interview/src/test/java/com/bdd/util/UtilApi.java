...
public class UtilApi {
    ...
    public static File getLastFileCreated(String resourcesPath, String directory, String format) {
        File theNewestFile = null;
        File dir = new File(resourcesPath + "/" + directory + "/" + format + "/");
        logger(UtilApi.class).log(Level.INFO, "Direccion absoluta {0}", dir.getAbsolutePath());
